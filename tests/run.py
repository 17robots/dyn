...
for name in ('compiler-contracts.py','lsp-contracts.py','lifetime-flow.py','semantic-combinations.py','standard-streams.py','stdlib-host.py','readiness-native.py','aggregate-abi.py','release-bundle.py'):
