  ...
  private:
    ...
    struct symbol_kind
    {
      enum symbol_kind_type
      {
        ...
        S_COMMA = 9,                             // COMMA
        S_COLON = 10,                            // COLON
        S_WHITESPACE = 11,                       // WHITESPACE
        S_ARROW = 12,                            // ARROW
        S_INT = 13,                              // INT
        S_DOUB = 14,                             // DOUB
        S_IDENT = 15,                            // IDENT
        S_16_pub_ = 16,                          // "pub"
        S_17_struct_ = 17,                       // "struct"
        S_18_enum_ = 18,                         // "enum"
        S_19_mut_ = 19,                          // "mut"
        S_20_con_ = 20,                          // "con"
        ...
        S_decls = 22,                            // decls
        S_decl = 23,                             // decl
        S_struct_decl = 24,                      // struct_decl
        S_traits = 25,                           // traits
        S_struct_members = 26,                   // struct_members
        S_enum_decl = 27,                        // enum_decl
        S_enum_members = 28,                     // enum_members
        S_partners = 29,                         // partners
        S_fn_sig = 30,                           // fn_sig
        S_fn_decl = 31,                          // fn_decl
        S_fn_args = 32,                          // fn_args
        S_var = 33,                              // var
        S_var_decl = 34,                         // var_decl
        S_stmts = 35,                            // stmts
        S_stmt = 36,                             // stmt
        S_block = 37,                            // block
        S_expr = 38,                             // expr
        S_fn_call = 39,                          // fn_call
        S_call_args = 40,                        // call_args
        S_ident = 41,                            // ident
        S_number = 42                            // number
      };
    };
        ...
        switch (this->kind ())
    {
      ...
      case symbol_kind::S_WHITESPACE: // WHITESPACE
...
switch (yykind)
    ...
    struct symbol_type : basic_symbol<by_kind>
    {
      ...
      {
#if !defined _MSC_VER || defined __clang__
        YY_ASSERT ((token::SEMICOLON <= tok && tok <= token::ARROW));
#endif
      }
#if 201103L <= YY_CPLUSPLUS
    ...
    // Implementation of make_symbol for each token kind.
      ...
      static
      symbol_type
      make_WHITESPACE (int v)
      {
        return symbol_type (token::WHITESPACE, std::move (v));
      }
#else
      static
      symbol_type
      make_WHITESPACE (const int& v)
      {
        return symbol_type (token::WHITESPACE, v);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
...
#line 2698 "parser.cc"
  ...
  case 19: // enum_members: ident L_PAREN partners R_PAREN
#line 58 "dyn.y"
...
#line 2794 "parser.cc"
  ...
  case 36: // var_decl: "con" var EQUAL expr SEMICOLON
#line 81 "dyn.y"
                                    { yylhs.value.as < Statement > () = Variable(yystack_[4].value.as< std::string > (), yystack_[3].value.as< Var > (), yystack_[1].value.as < Expression > (), &yystack_[0].value.as < int > ()); }
#line 2800 "parser.cc"
    break;

  case 37: // var_decl: var EQUAL expr SEMICOLON
#line 82 "dyn.y"
...
#line 2854 "parser.cc"
  ...
  case 46: // expr: fn_call
#line 95 "dyn.y"
      { yylhs.value.as < Expression > () = yystack_[0].value.as < Expression > (); }
#line 2860 "parser.cc"
    break;

  case 47: // fn_call: ident L_PAREN call_args R_PAREN
#line 97 "dyn.y"
...
#line 2878 "parser.cc"
  ...
  case 50: // call_args: call_args COMMA expr
#line 101 "dyn.y"
...
#line 2906 "parser.cc"
  ...
  parser::yypact_[] =
  {
      34,   -26,    58,    52,    52,    52,    52,    25,   -26,   -26,
     -26,     3,   -26,    30,    66,    52,   -26,    49,    69,    10,
      78,   -26,   -26,   -26,    58,    74,   -26,    74,    41,   -26,
     -26,    52,   -26,    52,   -26,    74,    74,   -26,    77,    82,
      93,     2,   -26,   -26,   -26,   -26,    90,   -26,    95,    52,
      11,   -26,    94,   -26,    24,    96,    75,    97,    98,   100,
      58,   -26,   -26,   -26,    74,   -26,   -26,   -26,    43,   -26,
     -26,    74,    52,   -26,    52,    52,   -26,   -26,   -26,   -26,
      27,    52,   -26,   102,   101,    56,    83,   -26,   -26,    74,
     -26,   -26,   -26,    52,   -26,   -26,    52,   -26,    86,   -26,
     -26
  };
  ...
  parser::yydefact_[] =
  {
       0,    51,     0,     0,     0,     0,     0,     0,     3,     8,
       7,     0,     6,     0,     0,     0,     2,     0,     0,     0,
       0,     1,     4,    26,    40,     0,    25,     0,    28,     5,
      33,    12,    11,    17,    34,     0,     0,    41,     0,     0,
       0,     0,    52,    53,    27,    46,    44,    45,     0,     0,
       0,    29,     0,    15,     0,     0,     0,    18,     0,     0,
      40,    43,    38,    42,    48,    37,    30,    24,     0,     9,
      13,     0,    12,    16,     0,     0,    35,    36,    39,    49,
       0,     0,    31,     0,     0,     0,     0,    22,    47,     0,
      32,    14,    10,     0,    20,    19,     0,    50,     0,    23,
      21
  };
  ...
  parser::yypgoto_[] =
  {
     -26,   -26,    16,   -26,   -26,    28,   -26,   -26,    14,   -26,
     -24,   -26,    -2,   -26,   -26,    48,   -26,   -25,   -19,   -26,
      -3,   -26
  };
  ...
  parser::yydefgoto_[] =
  {
       0,     7,    37,     9,    55,    52,    10,    56,    86,    11,
      12,    50,    13,    14,    38,    39,    26,    44,    45,    80,
      15,    47
  };
  ...
  parser::yytable_[] =
  {
      17,    18,    48,    19,    20,    40,    23,    53,    24,    64,
      58,    59,    30,    34,    35,    25,     8,     1,    16,    67,
      68,    41,    46,    22,    46,    21,    51,    70,    71,    54,
      57,    28,    46,    46,    27,    88,    89,    28,    30,    79,
       1,    40,     3,     4,     5,     6,    83,    66,    53,     1,
       2,     3,     4,     5,     6,    31,     1,    41,     1,    32,
      49,    46,    81,    93,    97,    94,    82,     1,    46,    29,
      54,    85,    87,     1,    33,     3,     4,     5,     6,    90,
      60,    73,    36,    61,    74,    62,    46,    42,    43,     1,
      87,    95,    96,    99,   100,    96,    63,    64,    65,    69,
      84,    76,    72,    77,    75,    91,    92,    98,    78
  };

  const signed char
  parser::yycheck_[] =
  {
       3,     4,    27,     5,     6,    24,     3,    31,     5,     7,
      35,    36,    15,     3,     4,    12,     0,    15,     2,     8,
       9,    24,    25,     7,    27,     0,    28,     3,     4,    31,
      33,     7,    35,    36,     4,     8,     9,     7,    41,    64,
      15,    60,    17,    18,    19,    20,    71,    49,    72,    15,
      16,    17,    18,    19,    20,     6,    15,    60,    15,    10,
      19,    64,    19,     7,    89,     9,    68,    15,    71,     3,
      72,    74,    75,    15,     5,    17,    18,    19,    20,    81,
       3,     6,     4,     6,     9,     3,    89,    13,    14,    15,
      93,     8,     9,    96,     8,     9,     3,     7,     3,     5,
      72,     3,     6,     3,     7,     3,     5,    93,    60
  };

  const signed char
  parser::yystos_[] =
  {
       0,    15,    16,    17,    18,    19,    20,    22,    23,    24,
      27,    30,    31,    33,    34,    41,    23,    41,    41,    33,
      33,     0,    23,     3,     5,    12,    37,     4,     7,     3,
      41,     6,    10,     5,     3,     4,     4,    23,    35,    36,
      39,    41,    13,    14,    38,    39,    41,    42,    38,    19,
      32,    33,    26,    31,    33,    25,    28,    41,    38,    38,
       3,     6,     3,     3,     7,     3,    33,     8,     9,     5,
       3,     4,     6,     6,     9,     7,     3,     3,    36,    38,
      40,    19,    33,    38,    26,    41,    29,    41,     8,     9,
      33,     3,     5,     7,     9,     8,     9,    38,    29,    41,
       8
  };
  ...
  "L_BRACE", "R_BRACE", "L_PAREN", "R_PAREN", "COMMA", "COLON",
  "WHITESPACE", "ARROW", "INT", "DOUB", "IDENT", "\"pub\"", "\"struct\"",
  "\"enum\"", "\"mut\"", "\"con\"", "$accept", "decls", "decl",
  "struct_decl", "traits", "struct_members", "enum_decl", "enum_members",
  "partners", "fn_sig", "fn_decl", "fn_args", "var", "var_decl", "stmts",
  "stmt", "block", "expr", "fn_call", "call_args", "ident", "number", YY_NULLPTR
  };
#endif
  ...
  parser::yyrline_[] =
  {
      ...
      42,    44,    46,    47,    48,    49,    54,    56,    57,    58,
      59,    60,    62,    63,    65,    67,    68,    69,    71,    72,
      73,    74,    75,    77,    79,    80,    81,    82,    84,    85,
